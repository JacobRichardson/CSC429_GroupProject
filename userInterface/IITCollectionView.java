...
public class IITCollectionView extends View {
	...
	private VBox createFormContent()
	{
		...
		iITTable.getColumns().addAll(itemTypeNameColumn, unitsColumn, unitMeasureColumn, validityDaysColumn, reorderPointColumn, notesColumn, statusColumn);
	...
	protected void processIITSelected()
	{
		...
		if(selectedItem != null)
		{
			...
			myModel.stateChangeRequest("VendorSelected", selectedItemTypeName);
		}
	}
