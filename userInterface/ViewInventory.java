...
public class ViewInventory extends View {
	...
	public ViewInventory(IModel wsc) {
		super(wsc, null);
	...
	private VBox createFormContent() {
		...
		Text prompt = new Text("Current Inventory");
		...
		dateRecievedColumn.setCellValueFactory(new PropertyValueFactory<ItemTableModel, String>("DateReceived"));
